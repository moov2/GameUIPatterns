...
function gp_remove_cpt_slug( $post_link, $post, $leavename ) {
    ...
    if ( 'gameui' != $post->post_type || 'publish' != $post->post_status ) {
        return $post_link;
    }
...
/**
 * Have WordPress match postname to any of our public post types (post, page, gameui)
...
function gp_parse_request_trick( $query ) {
    ...
    if ( ! empty( $query->query['name'] ) ) {
        $query->set( 'post_type', array( 'post', 'page', 'gameui' ) );
    }
}
